...
export interface paths {
  ...
  "/article/{slug}": {
    ...
    get: operations["get/article/{slug}"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  schemas: {
    ...
    ArticleRequest: {
      data: {
        ...
        myseo?: components["schemas"]["SharedSeoComponent"];
        comments?: (number | string)[];
        seo?: components["schemas"]["MetaMetadataComponent"];
    ...
    Article: {
      ...
      comments?: {
        ...
        /** Format: date-time */
        publishedAt?: string;
        createdBy?: components["schemas"]["CreatedByComponent"];
        updatedBy?: {
          id?: number;
          documentId?: string;
        };
    ...
    "Users-Permissions-PermissionsTree": Record<
      string,
      {
